...
class CategoryCreateView(CreateView, PermissionRequiredMixin):
    """ Класс создания категории медицинской услуги. """
    model = Category
...
class CategoryListView(ListView):
    """ Класс просмотра категорий медицинских услуг. """
    model = Category


class CategoryUpdateView(UpdateView, PermissionRequiredMixin):
    """ Класс редактирования категории медицинской услуги. """
    model = Category
    form_class = CategoryForm
...
class CategoryDeleteView(DeleteView, PermissionRequiredMixin):
    """ Класс удаления категории медицинской услуги. """
    model = Category
    success_url = reverse_lazy("medical_services:category_list")
...
class CategoryServiceListView(ListView):
    """ Класс просмотра услуг определенной категории медицинской услуги. """
    model = Service
...
class ServiceCreateView(CreateView, PermissionRequiredMixin):
    """ Класс создания медицинской услуги. """
    model = Service
...
class ServiceListView(ListView):
    """ Класс просмотра медицинских услуг. """
    model = Service


class ServiceDetailView(DetailView):
    """ Класс просмотра медицинской услуги. """
    model = Service
...
class ServiceUpdateView(UpdateView, PermissionRequiredMixin):
    """ Класс редактирования медицинской услуги. """
    model = Service
    form_class = ServicesForm
...
class ServiceDeleteView(DeleteView, PermissionRequiredMixin):
    """ Класс удаления медицинской услуги. """
    model = Service
    success_url = reverse_lazy("medical_services:service_list")
...
class ServiceCartView(View, LoginRequiredMixin):
    """ Класс просмотра корзины. """
    model = Cart
